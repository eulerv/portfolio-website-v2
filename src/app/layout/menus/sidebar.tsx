...
const Sidebar: React.FC = () => {
  return (
    ...
    >
      <button className="px-2 py-1 hover:text-zinc-900">
        <a href="/apiPicpay" className="flex float-left">
          <UserAdd className="size-6 mr-2" />
          <div className="hidden md:block">Visão Geral da API</div>
        </a>
      </button>
      <button className="px-2 py-1 hover:text-zinc-900">
        <a href="/apiPicpay/cadastro" className="flex float-left">
          <UserAdd className="size-6 mr-2" />
      ...
      <button className="px-2 py-1 hover:text-zinc-900">
        <a href="/" className="flex float-left hover:text-red-500">
          ...
          <div className="hidden md:block">Deletar Usuários</div>
        </a>
      </button>
    </motion.aside>
  );
