...
const InputForm = dynamic(() => import("@/app/apiPicpay/wallet/cadastrar/components/InputForm"), { ssr: false });
const RequestCard = dynamic(() => import("@/app/apiPicpay/wallet/cadastrar/components/requestCard"), { ssr: false });
const ResponseCard = dynamic(() => import("@/app/apiPicpay/wallet/cadastrar/components/responseCard"), { ssr: false });
